     ...
     switch (opcion){
         case 1: LCD_Cmd(1);
                 ...
                 do{
                     ...
                     conver1 = ADC_Read(0);
                     temp = conver1*0.4887;
                     sprintf (aux,"TEMP(INC):%3.1f",temp) ;
                     LCD_Out(2,1,aux);

                     conver2 = ADC_Read(1);
                     tempi = conver2*0.0391;
                     sprintf (aux,"TEMP(NEO):%3.1f",tempi) ;
                     LCD_Out(3,1,aux);
                     ...
                     if(temp<29){
                      ...
                      PORTD=0;
                      _delay((unsigned long)((350)*(4000000L/4000.0)));
                     }
                      if(temp>29&&temp<31){
                      PORTD=1;
                      ...
                      if(temp>31&&temp<33){
                      PORTD=1;
                      _delay((unsigned long)((3)*(4000000L/4000.0)));
                      PORTD=0;
                      _delay((unsigned long)((350)*(4000000L/4000.0)));
                     }
                      if(temp>33&&temp<37){
...
void __attribute__((picinterrupt((""))))nombre(){
    if(PIR1bits.RCIF==1){
        t=UART_Read();
        PIR1bits.RCIF=0;
